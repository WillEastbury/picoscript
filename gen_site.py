...
// Namespace reference
function buildNsRef(){
  var NS_DESC={Kernel:'IRQs, profiling, tracing',Req:'Read HTTP request (method, path, headers, body)',Resp:'Construct HTTP response',Queue:'Message queue ops',Random:'RNG',Memory:'Byte-addressable arena (native in toC)',Bits:'Bitwise & shift: and/or/xor/not/shl/shr/sar',Dot8:'Int8 dot product (NEON SDOT / Cortex-M33 SMLAD)',Span:'Zero-copy views',Descriptor:'Pool descriptors',Lease:'Memory leases',Storage:'PicoWAL card CRUD',Thread:'Yield hints',Io:'Direct output',Utf8Writer:'Byte/string writer',Utf8Reader:'Span scanner',Json:'JSON construction',Xml:'XML/HTML elements',String:'String library',Number:'Numeric library',Maths:'Math functions',DateTime:'Date/time',Locale:'i18n',Environment:'System info',Context:'Request context',Crypto:'Cryptography',Compress:'Compression',X509:'Certificates',Auth:'Authentication',Http:'HTTP parsing',Html:'HTML DOM'};
