...
def main():
    ...
    html = PAGE.replace("/*__HOOKS__*/", hooks_js) \
               ...
               .replace("/*__DD__*/", dd_js) \
               .replace("/*__FLOW__*/", flow_js) \
...
<div class="topbar">
  ...
  <a href="showcase.html" style="margin-left:auto;font-size:11px;color:var(--accent);text-decoration:none">&#128295; PicoShop showcase &#8599;</a>
  <a href="index.html" style="font-size:11px;color:var(--accent);text-decoration:none">&#128214; Full language guide &amp; reference &#8599;</a>
</div>
      ...
      <div class="dbg-panel" id="dbg-src">
        ...
        <div id="wfDesigner" class="wf-designer" style="display:none">
          <div class="wf-add">
            ...
            <span class="muted" style="font-size:11px">drag boxes from the palette; grab &#9095; to move or nest a box; edit fields inline</span>
          </div>
          <div id="wfFlow"></div>
          <div class="wf-eng-h">derived English (compiles &amp; runs; IL / bytecode / output in the debugger)</div>
...
// #wfFlow and emits the step list on every edit; we sync that to #src.
